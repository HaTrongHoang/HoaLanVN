...
@WebServlet(urlPatterns = "/admin/news/search")
public class SearchNewsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("newsListSearch", news);
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/admin/searchNews.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (key == "") {
			...
			resp.sendRedirect(req.getContextPath() + "/admin/news/search?key=" + key);
		}
	}
