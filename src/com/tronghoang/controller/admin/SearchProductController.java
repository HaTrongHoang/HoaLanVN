...
public class SearchProductController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/admin/searchProduct.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String status = req.getParameter("status");
		if (key == "") {
			resp.sendRedirect(req.getContextPath() + "/admin/product/search?key=" + "" + "&status=" + status);
		} else {
			resp.sendRedirect(req.getContextPath() + "/admin/product/search?key=" + key + "&status=" + status);
		}
	}
}
