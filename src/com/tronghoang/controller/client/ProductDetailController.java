...
@WebServlet(urlPatterns = "/traodoi/shop/gianhang/product/detail")
public class ProductDetailController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("detailProduct", product);
		RequestDispatcher dispatcher = req.getRequestDispatcher("/views/client/productDetail.jsp");
