...
public class RegisterController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/client/register.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (user.getPassword() == null) {
				resp.sendRedirect(req.getContextPath() + "/register?mess=password");
				System.out.println("mk k giong");
			}
			if (user.getUsername() == null) {
				resp.sendRedirect(req.getContextPath() + "/register?mess=username");
				System.out.println("username ton tai");
			} else {
				userDao.addUser(user);
				resp.sendRedirect(req.getContextPath() + "/login?mess=success");
