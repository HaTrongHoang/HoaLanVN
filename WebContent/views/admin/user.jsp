						...
						<div class="col-lg-12">
							...
							<div class="user-data m-b-30">
								<h3 class="title-3 m-b-30">
									<i class="zmdi zmdi-account-calendar"></i>Danh sách người dùng
								</h3>
								<div class="table-data__tool">
									<div class="table-data__tool-left">
										<button class=" au-btn-icon au-btn--small">
											<c:if test="${loginAdmin.role eq 0 }">
												<a href="/HoaLanVN/admin/user/add"><i
									...
									<div class="table-data__tool-right">
										...
										<form class="form-header" action="/HoaLanVN/admin/user/search"
											method="POST">
											...
											<c:forEach items="${userList}" var="user">
												<tr>
													...
													<td>
														<div class="table-data__info">
															<a
																href="/HoaLanVN/admin/user/detail?id_user=${user.id_user }"><h6>${user.fullname}</h6></a>
														</div>
													</td>
													<td>
														<div class="table-data__info">
													...
													<td><span class="role admin">${user.role}</span></td>
														...
														<td>
															<div class="table-data-feature">
																<button class="item" data-toggle="tooltip"
																	...
																	<a
																		href="/HoaLanVN/admin/user/update?id_user=${user.id_user }">
																...
																<button class="item" data-toggle="tooltip"
																	...
																	<a
																		href="/HoaLanVN/admin/user/delete?id_user=${user.id_user }"
