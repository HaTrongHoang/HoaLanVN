						...
						<div class="col-lg-12">
							...
							<div class="user-data m-b-30">
								<h3 class="title-3 m-b-30">
									<i class="zmdi zmdi-account-calendar"></i>${categoryName.name }
								</h3>
								<div class="table-data__tool">
									<div class="table-data__tool-left">
										<button class=" au-btn-icon au-btn--small">
											<a href="/HoaLanVN/admin/tutorial/add"><i
												class="zmdi zmdi-plus"></i>Thêm mới </a>
										</button>
									</div>
									<div class="table-data__tool-right">

										<form class="form-header" action="/HoaLanVN/admin/tutorial/search"
											method="POST">
											...
											<c:forEach items="${tutorialList}" var="tutorial">
												<tr>
													...
													<td>
														<div class="table-data__info">
															<a
																href="/HoaLanVN/admin/tutorial/detail?id_tutorial=${tutorial.id_tutorial }"><h6>${tutorial.title}</h6></a>
														</div>
													</td>
													<td>
														<div class="table-data__info">
															<h6>${tutorial.describe}</h6>
														</div>
													</td>
													<td>
														<div class="table-data__info">
													...
													<td>
														<div class="table-data__info">
															<h6>${tutorial.category_id.name}</h6>
														</div>
													</td>
													<td>
														<div class="table-data__info">
															<h6>${tutorial.id_user}</h6>
														</div>
													</td>
													
													<td><span class="table-data__info">${tutorial.date_created}</span></td>
													<td><span class="table-data__info">${tutorial.status}</span></td>
													<td>
														<div class="table-data-feature">
															...
															<button class="item" data-toggle="tooltip"
																...
																<a
																	href="/HoaLanVN/admin/tutorial/delete?category_id=${tutorial.category_id.id_category}&id_tutorial=${tutorial.id_tutorial }"
