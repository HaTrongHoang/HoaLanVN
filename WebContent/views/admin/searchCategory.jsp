							...
							<div class="user-data m-b-30">
								...
								<div class="table-data__tool">
									<div class="table-data__tool-left">
										<button class=" au-btn-icon au-btn--small">
											<a href="/HoaLanVN/admin/category/add"><i
												class="zmdi zmdi-plus"></i>THÊM DANH MỤC</a>
										</button>
									</div>
									<div class="table-data__tool-right">

										<form class="form-header" action="/HoaLanVN/admin/category/search"
											method="POST">
								...
								<div class="table-responsive table-data">
									<table class="table">
										...
										<tbody>
											<c:forEach items="${categoryListSearch}" var="category">
												<tr>
													<td>
														<div class="table-data__info">
															<h6>${category.id_category}</h6>
														</div>
													</td>
													<td>
														<div class="table-data__info">
													...
													<td>
														<div class="table-data-feature">
															<button class="item" data-toggle="tooltip"
																...
																<a
																	href="/HoaLanVN/admin/category/update?id_category=${category.id_category }">
															...
															<button class="item" data-toggle="tooltip"
																...
																<a
																	href="/HoaLanVN/admin/category/delete?id_category=${category.id_category }"
