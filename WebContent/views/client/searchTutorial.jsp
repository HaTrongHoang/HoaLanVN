						...
						<div class="col-lg-3">
							<div class="widget">
								<form class="form-inline search-form"
									action="/HoaLanVN/tutorial/search">
						...
						<c:forEach items="${tutorialList }" var="tutorial">
							<div class="blog-box row">
								...
								<div class="blog-meta big-meta col-md-8">
									...
									<small><a href="blog-category-01.html" title="">${tutorial.view }</a></small>
									<small><a href="single.html" title="">${tutorial.date_created }</a></small>
									<small><a href="blog-author.html" title="">${tutorial.category_id.name }</a></small>
								</div>
								<!-- end meta -->
							</div>
							<!-- end blog-box -->
