		...
		<div class="container content-md">
			<c:choose>
				<c:when test="${param.mess eq 'update' }">
					<div
						...
						<span class="badge badge-pill badge-success">Success</span> Sua
						thanh cong
				...
				<c:when test="${param.mess eq 'delete' }">
					<div
						class="sufee-alert alert with-close alert-success alert-dismissible fade show">
						<span class="badge badge-pill badge-success">Success</span> Xoa
						thanh cong
						<button type="button" class="close" data-dismiss="alert"
							aria-label="Close">
							<span aria-hidden="true">&times;</span>
				...
				<c:when test="${param.mess eq 'success' }">
					<div
						class="sufee-alert alert with-close alert-success alert-dismissible fade show">
						<span class="badge badge-pill badge-success">Success</span> Thêm
						thành công
						<button type="button" class="close" data-dismiss="alert"
							aria-label="Close">
							<span aria-hidden="true">&times;</span>
				...
				<div class="col-md-3 col-sm-6 md-margin-bottom-30">
					<form style="padding-bottom: 4rem;"
						...
						<input class="form-control form-control-sm ml-3 w-75" type="text"
							...
							name="key"> <input type="text" value="2" name="status"
							hidden="">
			...
			<div class="row ">
				<c:forEach items="${productListAll }" var="product">
					<div class="col-lg-3"
						style="padding-right: 6rem; padding-bottom: 6rem">
